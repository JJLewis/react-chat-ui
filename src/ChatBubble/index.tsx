...
export default class ChatBubble extends React.Component {
  ...
  public render() {
    ...
    const readStatus=(
      ...
      (
      <svg style={{float:'right',display:'inline-block',marginLeft:'6px',marginTop:'9px'}} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50" width="15" height="15">
      <g id="surface1_4_">
