...
class ChatBubble extends React.Component {
    ...
    render() {
        ...
        const readStatus = (this.props.message.id === 0 && this.props.message.isRead &&
            (React.createElement("svg", { style: { float: 'right', display: 'inline-block', marginLeft: '6px', marginTop: '5px' }, version: "1.1", id: "Layer_1", xmlns: "http://www.w3.org/2000/svg", x: "0px", y: "0px", viewBox: "0 0 50 50", width: "15", height: "15" },
